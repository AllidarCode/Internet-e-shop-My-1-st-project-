            ...
            <form action="review.php" method="post">
                ...
                <div
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <span class="badge bg-warning position-absolute end-0 mt-n2" data-bs-toggle="tooltip" title="Reward points"><?= $u['id'] ?></span><img
                                class="rounded-circle" src="img/user_photo.png" width="90" alt="Susan Gardner"></div>
                        <div class="ps-3">
                            <h3 class="fs-base mb-0"><?= $u['first_name']." "
                                .$u['last_name'] ?></h3>
                ...
                <div class="d-none d-lg-flex pt-4 mt-3">
                    ...
                    <div class="w-50 ps-2">
                        <button type="submit" class="btn btn-primary d-block w-100" href="checkout-shipping.html"><span class="d-none d-sm-inline">Proceed to Shipping</span><span
