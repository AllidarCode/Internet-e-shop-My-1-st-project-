        ...
        <div class="order-lg-2 mb-3 mb-lg-0 pt-lg-2">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light flex-lg-nowrap justify-content-center justify-content-lg-start">
                    ...
                    <li class="breadcrumb-item text-nowrap active" aria-current="page">Cart
                    </li>
                </ol>
            </nav>
        </div>
...
<div class="container pb-5 mb-2 mb-md-4">
    <div class="row">
        ...
        <section class="col-lg-8">
                    ...
                    <div class="d-sm-flex justify-content-between align-items-center my-2 pb-3 border-bottom">
                        <div class="d-block d-sm-flex align-items-center text-center text-sm-start">
                            ...
                            <div class="pt-2">
                                ...
                                <div class="fs-sm"><span class="text-muted me-2">UNIT PRICE:$
                                        <?= $item['pro']['price'] ?> </span>
                                </div>
                        ...
                        <div class="pt-2 pt-sm-0 ps-sm-3 mx-auto mx-sm-0 text-center text-sm-start" style="max-width: 9rem;">
                            ...
                            <input class="form-control" type="number" id="quantity1" min="1" value="
                            <?= $item['quantity'] ?>">
                            <a href="cart-process-remove.php?id=
                            <?= $item['pro']['id'] ?>" class="btn btn-link px-0 text-danger" type="button">
            ...
            <button class="btn btn-outline-accent d-block w-100 mt-4" type="button"><i class="ci-loading fs-base me-2"></i>Update cart
            </button>
        </section>
        <!-- Sidebar-->
                                ...
                                <div class="accordion-body">
                                    <form class="needs-validation" novalidate>
                                        <div class="mb-3">
                                            ...
                                            <div class="invalid-feedback">Please choose your country!
                                            </div>
                                        </div>
                                        <div class="mb-3">
                                            <select class="form-select" required>
                                            ...
                                            <div class="invalid-feedback">Please choose your city!
                                            </div>
                                        </div>
                                        <div class="mb-3">
