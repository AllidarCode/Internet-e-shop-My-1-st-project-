...
<head>
    ...
    <meta name="author" content="AllidarSU">
    <!-- Viewport-->
        ...
        <div class="modal-content">
            <div class="modal-header bg-secondary">
                <ul class="nav nav-tabs card-header-tabs" role="tablist">
                    <li class="nav-item"><a class="nav-link fw-medium active" href="#signin-tab" data-bs-toggle="tab" role="tab" aria-selected="true"><i class="ci-unlocked me-2 mt-n1"></i>Sign in</a>
                    </li>
            ...
            <div class="modal-body tab-content py-4">
                <form class="needs-validation tab-pane fade show active" autocomplete="off" novalidate id="signin-tab">
                    ...
                    <button class="btn btn-primary btn-shadow d-block w-100" type="submit">Sign in
                    </button>
                </form>
                <form class="needs-validation tab-pane fade" autocomplete="off" novalidate id="signup-tab">
                    ...
                    <button class="btn btn-primary btn-shadow d-block w-100" type="submit">Sign up
                    </button>
                </form>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title product-title"><a href="shop-single-v1.html" data-bs-toggle="tooltip" data-bs-placement="right" title="Go to product page">Sports Hooded Sweatshirt<i class="ci-arrow-right fs-lg ms-2"></i></a>
                    </h4>
                    <button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                            ...
                            <div class="product-details ms-auto pb-3">
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    <a href="shop-single-v1.html#reviews">
                                        ...
                                        <span class="d-inline-block fs-sm text-body align-middle mt-1 ms-1">74 Reviews</span></a>
                                ...
                                <div class="fs-sm mb-4"><span
                                        ...
                                        class="text-muted" id="colorOptionText">Red/Dark blue/White</span>
                                </div>
                                ...
                                <form class="mb-grid-gutter">
                                    ...
                                    <div class="mb-3 d-flex align-items-center">
                                        ...
                                        <button class="btn btn-primary btn-shadow d-block w-100" type="submit"><i class="ci-cart fs-lg me-2"></i>Add to Cart
                                        </button>
                                    </div>
                                </form>
    ...
    <header class="shadow-sm">
            ...
            <div class="container">
                <div class="topbar-text dropdown d-md-none"><a class="topbar-link dropdown-toggle" href="#" data-bs-toggle="dropdown">Useful links</a>
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="tel:380998997979"><i class="ci-support text-muted me-2"></i>(380) 99 899 7979</a></li>
                        <li><a class="dropdown-item" href="order-tracking.html"><i class="ci-location text-muted me-2"></i>Order tracking</a></li>
                    </ul>
                </div>
                <div class="topbar-text text-nowrap d-none d-md-inline-block"><i
                        class="ci-support"></i><span class="text-muted me-1">Support</span><a
                        class="topbar-link" href="tel:38099000009">(+380) 99 000 0099</a></div>
                <div class="tns-carousel tns-controls-static d-none d-md-block">
                    <div class="tns-carousel-inner" data-carousel-options="{&quot;mode&quot;: &quot;gallery&quot;, &quot;nav&quot;: false}">
                        <div class="topbar-text">Free shipping for order over $200
                        </div>
                        <div class="topbar-text">We return money within 30 days
                        </div>
                        <div class="topbar-text">Friendly 24/7 customer support
                        </div>
                    </div>
                </div>
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li class="dropdown-item">
                                <select class="form-select form-select-sm">
                                    <option value="usd">$ USD</option> <!-- United States -->
                                    <option value="eur">€ EUR</option> <!-- European Union -->
                                    <option value="ukp">£ UKP</option> <!-- United Kingdom -->
                                    <option value="uah">₴ UAH</option> <!-- Ukraine -->
                                </select>
                            </li>
                            <li><a class="dropdown-item " href="#"><img class="me-2" src="img/flags/ua.png" width="20" alt="Ukraine">Ukraine</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="navbar-sticky bg-light">
            <div class="navbar navbar-expand-lg navbar-light">
                <div class="container"><a class="navbar-brand d-none d-sm-block flex-shrink-0" href="<?= url(' ') ?>"><img src="img/logo-dark.png" width="142" alt="E-shop"></a>
                    ...
                    <div class="navbar-toolbar d-flex flex-shrink-0 align-items-center">
                        ...
                        <?php } ?> My Account</div></a>
                            <div class="navbar-tool dropdown ms-3"><a class="navbar-tool-icon-box bg-secondary dropdown-toggle" href="shop-cart.html"><span class="navbar-tool-label"><?= $cart_count ?></span><i class="navbar-tool-icon ci-cart"></i></a><a class="navbar-tool-text" href="shop-cart.html"><small>My Cart</small>$<?= $cart_total ?>.00</a>
                                <!-- Cart dropdown-->
                        ...
                        <?php foreach ($cart_items as $key => $item) { ?>
                                            <div class="widget-cart-item pb-2 border-bottom">
                                                <a class="btn-close text-danger" href="cart-process-remove.php?id=<?= $item['pro']['id'] ?>" type="button" aria-label="Remove"><span aria-hidden="true">&times;</span></a>
                                                <div class="d-flex align-items-center"><a class="flex-shrink-0" href="product.php?id=<?= $item['pro']['id'] ?>"><img src="<?= get_product_thumb($item['pro']['photos']) ?>" width="64" alt="Product"></a>
                                                    <div class="ps-2">
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">Pages</a>
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item" href="mailto:allidars.code@gmail.com">
                                            <div class="d-flex">
                                                <div class="lead text-muted pt-1">
                                                </div>
                                                <div class="dropdown"><span class="d-block text-heading">Support</span>
                                                </div>
                                            </div>
                                        </a></li>
                                </ul>
