        ...
        <div class="container">
            ...
            <div class="row pb-2">
                <div class="col-md-6 text-center text-md-start mb-4">
                    <div class="text-nowrap mb-4"><a class="d-inline-block align-middle mt-n1 me-3" href="#"><img class="d-block" src="img/footer-logo-light.png" width="117" alt="E-shop"></a>
            ...
            <div class="pb-4 fs-xs text-light opacity-50 text-center text-md-start">© All rights reserved. Made by <a class="text-light" href="https://www.upwork.com/freelancers/~014869ac231f31749b/" target="_blank" rel="noopener">AllidarSU</a></div>
        </div>
    </div>
</footer>
